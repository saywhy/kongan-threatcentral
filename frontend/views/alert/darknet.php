    ...
    <div class="darknet_table">
      <table class="table  table-striped table_th ng-cloak">
        ...
        <tr class="alert_table_tr" ng-repeat="item in darknet_list_data.data">
          ...
          <td>
            ...
            <img src="/images/alert/down_load.png" class="img_margin" ng-click="darknet_download(item.rar_name)" alt="">
            <img src="/images/alert/set.png" class="img_margin" ng-click="set_model(item)" alt="">
          </td>
        </tr>
      </table>
      <p>
        <em style="font-size: 14px;padding-left:36px;color: #999;">共有<span
      ...
      <div style="padding: 0px; position: relative;height:60px;">
        ...
        <ul class="pagination pagination-sm  pull-right ng-cloak" style="margin-right:36px;">
          ...
          <li><a href="javascript:void(0);" ng-click="get_dark_list(1)" ng-if="darknet_list_data.pageNow>1">1</a>
          </li>
          ...
          <li><a href="javascript:void(0);" ng-click="get_dark_list(darknet_list_data.pageNow+1)"
              ng-bind="darknet_list_data.pageNow+1" ng-if="darknet_list_data.pageNow<darknet_list_data.maxPage-1"></a>
          </li>
          <li><a href="javascript:void(0);" ng-click="get_dark_list(darknet_list_data.pageNow+2)"
              ng-bind="darknet_list_data.pageNow+2" ng-if="darknet_list_data.pageNow<darknet_list_data.maxPage-2"></a>
          </li>
          <li><a href="javascript:void(0);" ng-if="darknet_list_data.pageNow<darknet_list_data.maxPage-3">...</a></li>

          <li><a href="javascript:void(0);" ng-click="get_dark_list(darknet_list_data.maxPage)"
              ng-bind="darknet_list_data.maxPage" ng-if="darknet_list_data.pageNow<darknet_list_data.maxPage"></a></li>
          <li><a href="javascript:void(0);" ng-click="get_dark_list(darknet_list_data.pageNow+1)"
