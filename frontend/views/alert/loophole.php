    ...
    <div class="loop_table_box" ng-click="alert_box()">
      <div class="alert_box_top">
        ...
        <div class="sun_select_box">
          <li class="sun_select_input" ng-click="focus_select()">{{loop_serch_data.company}}</li>
          ...
          <ul class="sun_select_ul" ng-if="select_ul">
            <li ng-repeat='item in company_select_loophole'
              ng-class="item.type==loop_serch_data.company?'sun_active':''" class="sun_select_li"
        ...
        <!-- 请选择资产分组 -->
        <div class="sun_select_box">
          <li class="sun_select_input" ng-click="focus_select_poc()">{{loop_serch_data.poc}}</li>
          <img src="/images/home/select_icon2.png" class="sun_select_icon" ng-click="focus_select_poc()" alt="">
          <ul class="sun_select_ul" ng-if="select_ul_poc">
            <li ng-repeat='item in poc_selsect' ng-class="item.type==loop_serch_data.poc?'sun_active':''"
              class="sun_select_li" ng-click="choose_item_poc(item)">{{item.type}}
            </li>
          </ul>
        </div>
      ...
      <div class="row" style="margin:0;padding:24px 0" ng-click="blur_input()">
        ...
        <p>
          <em style="font-size: 12px;padding-left:36px;color: #BBBBBB;">共有<span ng-bind="loophole.count"></span>条预警</em>
        </p>
