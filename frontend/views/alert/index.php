  ...
  <div class="alert_box" ng-click="alert_box()">
    <div class="alert_box_top">
      ...
      <div class="sun_select_box">
        <li class="sun_select_input" ng-click="focus_select()">{{searchData.category}}</li>
        <img src="/images/home/select_icon2.png" class="sun_select_icon" ng-click="focus_select()" alt="">
        <ul class="sun_select_ul" ng-if="select_ul">
          <li ng-repeat='item in category_select' ng-class="item.type==searchData.category?'sun_active':''"
      ...
      <!-- 请选择资产分组 -->
      <div class="sun_select_box">
        <li class="sun_select_input" ng-click="focus_select_company()">{{searchData.company}}</li>
        <img src="/images/home/select_icon2.png" class="sun_select_icon" ng-click="focus_select_company()" alt="">
        <ul class="sun_select_ul" ng-if="select_ul_company">
          <li ng-repeat='item in company_select' ng-class="item.type==searchData.company?'sun_active':''"
            class="sun_select_li" ng-click="choose_item_company(item)">{{item.type}}
          </li>
        </ul>
      </div>
    ...
    <div class="row" style="margin:0;padding:24px 0" ng-click="blur_input()">
          ...
          <td style="padding-right:36px;" class="td_operation" ng-click="$event . stopPropagation();">
            <button class="btn_look" ng-click="operation_click($index);$event.stopPropagation();"
              ...
              <ul class="td_ul" ng-if="item_operation == $index ">
                ...
                <li class="td_li" ng-click="update_alert(item,'4');$event.stopPropagation();"
                  ng-if="item.category=='钓鱼仿冒'&& item.status!='4'">
                  白名单
                </li>
                <li class="td_li" ng-if="item.status=='4'" ng-click="update_alert(item,'5'); $event.stopPropagation();">
                  取消白
                </li>
              </ul>
            </button>
      ...
      <p>
        <em style="font-size: 12px;padding-left:36px;color: #BBBBBB;">共有<span ng-bind="pages.count"></span>条预警</em>
      </p>
