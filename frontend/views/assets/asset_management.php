  ...
  <div class="Management_main">
    <div class="Management_main_top">
      <div class="Management_main_top_box">
        ...
        <span class="input_box_item" ng-if="host_search_if">
          <input class="input_box" placeholder="输入资产名称" ng-model="search.host_asset_name"
            ng-focus="get_host_name_focus()" ng-blur="get_host_name_blur()"
            ng-keyup="myKeyup_host_name(search.host_asset_name)" type="text">

          <ul class="container_ul" ng-show="host_name_list_if">
            <li ng-repeat="item in host_name_list" class="li_hover" ng-click="host_name_list_click(item.asset_name)">
              {{item.asset_name}}
            </li>
          </ul>
          <img src="/images/alert/search_icon.png" class="search_icon" alt="">
        ...
        <span class="input_box_item" ng-if="host_search_if">
          <input class="input_box" type="text" placeholder="输入资产分组名称" ng-model="search.host_group_name"
            ng-focus="get_host_group_focus()" ng-keyup="myKeyup_host_group(search.host_group_name)">
          <ul class="container_ul" ng-show="host_group_list_if">
            <li ng-repeat="item in host_group_list" class="li_hover" ng-click="host_group_list_click(item.group_name)">
              {{item.group_name}}
            </li>
          </ul>
          <img src="/images/alert/search_icon.png" class="search_icon" alt="">
    ...
    <div ng-click="table_click()">
      <ul class="nav nav-tabs detail_bom_nav">
        ...
        <li role="presentation"><a href="#loophole" data-toggle="tab" ng-click="tab_active(2)">主机资产（
            <span>{{host_data.count}}</span> ）</a>
        </li>
      </ul>
        ...
        <div id="info" class="tab-pane active">
          <table class="table ng-cloak domain_table">
            ...
            <tr style="cursor: pointer;" ng-repeat="item in domain_data.data">
              ...
              <td class="cursor">
                <img src="/images/set/cel_icon.png" width="16" height="16" style="margin-right:5px;"
                  ng-disabled="item.in_type == 'api'" ng-click="del_domain(item.asset_name)" alt="">

                <img src="/images/set/edit_icon.png" width="16" height="16" ng-disabled="item.in_type == 'api'"
                  ng-click="edit_domain(item)" alt="">
          ...
          <div style="border-top: 1px solid #f4f4f4;padding: 20px;">
            ...
            <ul class="pagination pagination-sm no-margin pull-right ng-cloak">
              ...
              <li><a href="javascript:void(0);" ng-click="domain_get(1)" ng-if="domain_data.pageNow>1">1</a></li>
              ...
              <li><a href="javascript:void(0);" ng-click="domain_get(domain_data.pageNow+1)"
                  ng-bind="domain_data.pageNow+1" ng-if="domain_data.pageNow<domain_data.maxPage-1"></a></li>
              <li><a href="javascript:void(0);" ng-click="domain_get(domain_data.pageNow+2)"
                  ng-bind="domain_data.pageNow+2" ng-if="domain_data.pageNow<domain_data.maxPage-2"></a></li>
              <li><a href="javascript:void(0);" ng-if="domain_data.pageNow<domain_data.maxPage-3">...</a>
              </li>

              <li><a href="javascript:void(0);" ng-click="domain_get(domain_data.maxPage)" ng-bind="domain_data.maxPage"
                  ng-if="domain_data.pageNow<domain_data.maxPage"></a>
              </li>
              <li><a href="javascript:void(0);" ng-click="domain_get(domain_data.pageNow+1)"
        ...
        <div id="loophole" class="tab-pane">
          <table class="table ng-cloak domain_table">
            ...
            <tr style="cursor: pointer;" ng-repeat="item in host_data.data">
              ...
              <td class="cursor">
                <img src="/images/set/cel_icon.png" width="16" height="16" style="margin-right:5px;"
                  ng-disabled="item.in_type == 'api'" ng-click="del_host(item.asset_name)" alt="">
                <img src="/images/set/edit_icon.png" width="16" height="16" ng-disabled="item.in_type == 'api'"
                  ng-click="edit_host(item)" alt="">
              </td>
            </tr>
          </table>
          <div style="border-top: 1px solid #f4f4f4;padding: 20px;">
            ...
            <ul class="pagination pagination-sm no-margin pull-right ng-cloak">
              ...
              <li><a href="javascript:void(0);" ng-click="host_get(host_data.pageNow-2)" ng-bind="host_data.pageNow-2"
                  ng-if="host_data.pageNow>3"></a></li>
              <li><a href="javascript:void(0);" ng-click="host_get(host_data.pageNow-1)" ng-bind="host_data.pageNow-1"
                  ng-if="host_data.pageNow>2"></a></li>
              <li class="active"><a href="javascript:void(0);" ng-bind="host_data.pageNow"></a>
              </li>
              <li><a href="javascript:void(0);" ng-click="host_get(host_data.pageNow+1)" ng-bind="host_data.pageNow+1"
                  ng-if="host_data.pageNow<host_data.maxPage-1"></a>
              </li>
              <li><a href="javascript:void(0);" ng-click="host_get(host_data.pageNow+2)" ng-bind="host_data.pageNow+2"
                  ng-if="host_data.pageNow<host_data.maxPage-2"></a>
              </li>
              <li><a href="javascript:void(0);" ng-if="host_data.pageNow<host_data.maxPage-3">...</a></li>
              <li><a href="javascript:void(0);" ng-click="host_get(host_data.maxPage)" ng-bind="host_data.maxPage"
                  ng-if="host_data.pageNow<host_data.maxPage"></a>
              </li>
              <li><a href="javascript:void(0);" ng-click="host_get(host_data.pageNow+1)"
        ...
        <div class="box-body ">
          <div>
            <ul class="nav nav-tabs detail_bom_nav" style="margin-bottom:-1px;">
              <li class="active">
                <a href="#domain_add" data-toggle="tab" ng-click="domain_add_acttiv()" aria-expanded="true">网站资产</a>
              </li>
              <li><a href="#host_add" data-toggle="tab" ng-click="host_add_acttiv()" aria-expanded="true">主机资产</a></li>
            </ul>
            <div class="tab-content" style="margin-top:10px;">
              <div id="domain_add" class="tab-pane active">
                <div class="row">
                  <div class="col-md-4 col_md_input">
                    <label>资产名称</label>
                    <input class="form-control" ng-model="domain_add.asset_name" style="border-radius: 3px">
                  </div>
                  <div class="col-md-4 col_md_input">
                    <label>资产分组</label>
                    <input class="form-control" ng-model="domain_add.group_name" style="border-radius: 3px">
                  </div>
                  <div class="col-md-4 col_md_input">
                    <label>关联域名</label>
                    <input class="form-control" ng-model="domain_add.domain" style="border-radius: 3px">
                  </div>
                </div>
                <br>
                <div class="row">
                  ...
                  <div class="col-md-4 col_md_input">
                    <label>地理位置</label>
                    <input class="form-control" ng-model="domain_add.location" style="border-radius: 3px">
                  </div>
                  <!-- <div class="col-md-3">
                                        <label>责任人</label>
              ...
              <div id="host_add" class="tab-pane ">
                <div class="row">
                  ...
                  <div class="col-md-4 col_md_input">
                    <label>主机地址</label>
                    <input class="form-control" ng-model="host_add.asset_name" style="border-radius: 3px">
                  </div>
                  <div class="col-md-4 col_md_input">
                    <label>资产分组</label>
                    <input class="form-control" ng-model="host_add.group_name" style="border-radius: 3px">
                  </div>
                  <div class="col-md-4 col_md_input">
                    <label>操作系统</label>
                ...
                <div class="row">
                  <div class="col-md-4 col_md_input">
                    <label>关联域名</label>
                    <input class="form-control" ng-model="host_add.domain" style="border-radius: 3px">
                  </div>
                  <div class="col-md-4 col_md_input">
                    <label>地理位置</label>
                    <input class="form-control" ng-model="host_add.location" style="border-radius: 3px">
                  </div>
                  <div class="col-md-4 col_md_input">
                    <label>主机状态</label>
                    <select class="form-control input_radius" style="background-color: #fff;"
                      ng-model="host_add.is_alive" ng-options="x.num as x.type for x in host_statusData"></select>
                  </div>
                  <!-- <div class="col-md-3">
                                        <label>责任人</label>
              ...
              <div id="domain_edit_li" class="tab-pane active">
                <div class="row">
                  <div class="col-md-3 col_md_input">
                    <label>资产名称</label>
                    <input class="form-control" ng-model="domain_edit_data.asset_name" style="border-radius: 3px">
                  </div>
                  <div class="col-md-3 col_md_input">
                    <label>资产分组</label>
                    <input class="form-control" ng-model="domain_edit_data.group_name" style="border-radius: 3px">
                  </div>
                  <div class="col-md-3 col_md_input">
                    <label>资产状态</label>
                    <select class="form-control input_radius" style="background-color: #fff;"
                ...
                <div class="row">
                  <div class="col-md-3 col_md_input">
                    <label>关联域名</label>
                    <input class="form-control" ng-model="domain_edit_data.domain" style="border-radius: 3px">
                  </div>
                  <div class="col-md-3 col_md_input">
                    <label>地理位置</label>
                    <input class="form-control" ng-model="domain_edit_data.location" style="border-radius: 3px">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="tab-content" style="margin-top:10px;">
              <div id="host_edit_li" class="tab-pane active">
                <div class="row">
                  <div class="col-md-3 col_md_input">
                    <label>主机地址</label>
                    <input class="form-control" ng-model="host_edit_data.asset_name" style="border-radius: 3px">
                  </div>
                  <div class="col-md-3 col_md_input">
                    <label>资产分组</label>
                    <input class="form-control" ng-model="host_edit_data.group_name" style="border-radius: 3px">
                  </div>
                  <div class="col-md-3 col_md_input">
                    <label>操作系统</label>
                    <input class="form-control" ng-model="host_edit_data.os" style="border-radius: 3px">
                  </div>
                  <div class="col-md-3 col_md_input">
                    <label>关联域名</label>
                    <input class="form-control" ng-model="host_edit_data.domain" style="border-radius: 3px">
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col-md-3 col_md_input">
                    <label>主机状态</label>
                    <select class="form-control input_radius" style="background-color: #fff;"
                      ng-model="host_edit_data.is_alive" ng-options="x.num as x.type for x in host_statusData"></select>
                  </div>
                  <div class="col-md-3 col_md_input">
                    <label>地理位置</label>
                    <input class="form-control" ng-model="host_edit_data.location" style="border-radius: 3px">
                  </div>
                </div>
              </div>
            </div>
      ...
      <form>
        <div class="box-body ">
          ...
          <div class="row" style="margin-top:20px;">
            ...
            <div class="col-md-3">
              <input type="radio" ng-value=true ng-model="export_risk_data" name="selectState" ng-checked="true">
              <span>主机资产</span>
            </div>
            <div class="col-md-3">
