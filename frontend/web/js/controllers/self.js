...
selfApp.controller("selfCtrl", function (
    ...
    $scope.init = function () {
        $scope.pswd_show = false;
        $scope.out_show = false;
    }
    ...
    $scope.mouseover_pswd = function () {
        $scope.pswd_show = true;
    }
    $scope.mouseleave_pswd = function () {
        $scope.pswd_show = false;
    }
    $scope.mouseover_out = function () {
        $scope.out_show = true;
    }
    $scope.mouseleave_out = function () {
        $scope.out_show = false;
    }
    $scope.init()
});
