...
myApp.controller("myCtrl", function ($scope, $http, $filter, $sce) {
    ...
    $scope.focus_select = function () {
        $scope.select_ul = !$scope.select_ul
        $scope.select_ul_company = false;
    }
    $scope.choose_item = function (item) {
        $scope.searchData.category = item.type;
        $scope.select_ul = false;
    }
    $scope.focus_select_company = function () {
        $scope.select_ul_company = !$scope.select_ul_company;
        $scope.select_ul = false;
    }
    $scope.choose_item_company = function (item) {
        $scope.searchData.company = item.type;
        $scope.select_ul_company = false;
    }
    ...
    $scope.search = function () {
        ...
        var category_data = ''
        var company_data = ''
        if ($scope.searchData.category != '请选择预警类型') {
            category_data = $scope.searchData.category
        }
        if ($scope.searchData.company != '请选择资产分组') {
            company_data = $scope.searchData.company
        }
