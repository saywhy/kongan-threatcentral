                ...
                function (data) {
                    ...
                    if (data.data.status == "success") {
                        if (data.data.data.result == null) {
                            ...
                            console.log($scope.reputation_res.sources)
                            $scope.reputation_res.sources.forEach((element, index) => {
                                console.log(element.replace('hoohoolab_', 'TICPSH_'))
                                $scope.reputation_res.sources[index] = element.replace('hoohoolab_', 'TICPSH_')
                                console.log(element)
                            });
