...
myApp.controller("indexCtrl", function ($scope, $http, $filter) {
    ...
    $scope.threat_categories = function (item) {
        ...
        var color_list = ["#8DF97F", "#9C00E5", "#0E79FF", "#FF35C1", "#BECE2A",
            '#0E79FF', '#41B3F9', '#962116', '#4AA46E', '#AE5BD5'
        ];
        angular.forEach($scope.item_data, function (item, index) {
            switch (index % 10) {
                case 0:
                    item.style = {
                        background: "#8DF97F"
        ...
        var option = {
            ...
            color: ["#8DF97F", "#9C00E5", "#0E79FF", "#FF35C1", "#BECE2A",
                '#0E79FF', '#41B3F9', '#962116', '#4AA46E',
                '#AE5BD5'
            ],
            // ["#8DF97F", "#9C00E5", "#0E79FF", "#FF35C1", "#BECE2A"]
            series: [{
                type: "pie",
                radius: [70, 120],
